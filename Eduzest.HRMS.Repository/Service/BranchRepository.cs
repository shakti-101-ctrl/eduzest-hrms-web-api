...
namespace Eduzest.HRMS.Repository.Service
{
    public class BranchRepository:GenericRepository<Branch>,IBranchRepository
    {
        ...
        public BranchRepository(DataContext context,IMapper _mapper, ILogger<BranchRepository> logger) :base(context,_mapper)
        {
        ...
        //public Task<ServiceResponse<BranchDto>> Delete(Guid id, BranchDto entity)
        //{
        ...
        //public Task<ServiceResponse<List<BranchDto>>> GetAll()
        //{
        //    throw new NotImplementedException();
        //}
